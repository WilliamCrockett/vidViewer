...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://vid-viewer-api.herokuapp.com/',
...
var showCrewsTemplate = __webpack_require__(18);

var populateTableWithIndex = function populateTableWithIndex(data) {
  var showVideosHtml = showCrewsTemplate({ videos: data.videos });
  $('#videosTable tbody').empty();
  $('#videosTable tbody').append(showVideosHtml);
};

var onGetVideoById = function onGetVideoById(data) {
...
var appEvents = __webpack_require__(36);
...
var appAPI = __webpack_require__(6);
var appUI = __webpack_require__(7);

var onSignIn = function onSignIn(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.signIn(data).then(ui.onSignInSuccess).catch(ui.onSignInFailure).then(appAPI.getAll).then(appUI.populateTableWithIndex).catch(console.error);
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<tr class='header_row'>\n  <th>Name</th>\n  <th>Date</th>\n  <th>Delete</th>\n</tr>\n\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.videos : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
var onRowClick = function onRowClick() {
  ...
  api.getVideoByID(id).then(ui.onGetVideoById).catch(ui.onGetVideoByIdError);
};
